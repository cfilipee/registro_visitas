...
<body class="text-center">
  ...
  <main class="form-signin">
    <form class="needs-validation" novalidate method="POST" action="valida.php">
      ...
      <h1 class="h3 mb-3 fw-normal">SIS-CAD</h1>
      <p class="mt-1 mb-0 text-primary"></p>
      <p class="mt-1 mb-0 text-primary"></p>

      <div class="form-floating">
        <input type="text" class="form-control" id="floatingInput" name="usuario" placeholder="Informe seu usuário" autocomplete="off" required>
      ...
      <p class="mt-5 mb-1 text-muted">&copy; 2022 - <?php echo date('Y') ?></p>
      <p class="mt-1 mb-1 text-muted">Sistema de Cadastro - All Rights Reserved</p>
      <p class="mt-1 mb-1 text-muted">Versão 1.0.1</p>
