...
<table class="table table-bordered table-hover table-sm table-responsive-xl resultado_cliente">
    ...
    <!--REQUISIÇÃO DO BANCO PARA A TELA (linha 80 Continuação)-->
    <?php
    ...
    <!--AMOSTRAGEM DE INFORMAÇÕES PARA A TELA (ECHO)-->
        <tbody>
            <tr>
                ...
                <td class="text text-center">
                    <a href="processa_excluir_clientes.php?id=<?php echo $linha['nome']; ?>" onClick="return confirm('Deseja realmente excluir <?php echo $linha['nome']; ?>')">
